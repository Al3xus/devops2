...
am__depfiles_remade = ./$(DEPDIR)/FuncA.Po ./$(DEPDIR)/main.Po \
	./$(DEPDIR)/server.Po ./$(DEPDIR)/test_FuncA.Po
am__mv = mv -f
...
ACLOCAL = ${SHELL} '/home/rovniy/devops2/devops2/missing' aclocal-1.16
AMTAR = $${TAR-tar}
...
STRIP = 
VERSION = 1.0
abs_builddir = /home/rovniy/devops2/devops2
...
install_sh = ${SHELL} /home/rovniy/devops2/devops2/install-sh
